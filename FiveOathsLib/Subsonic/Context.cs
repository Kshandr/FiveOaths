...
{
    public partial class fiveoaths_devDB : IQuerySurface
    {
        ...
        public fiveoaths_devDB() 
        {
            if (DefaultDataProvider == null) {
                DataProvider = ProviderFactory.GetProvider("fiveoaths");
            }
            else {
        ...
        public fiveoaths_devDB(string connectionStringName)
        {
            DataProvider = ProviderFactory.GetProvider(connectionStringName);
            Init();
        }

		public fiveoaths_devDB(string connectionString, string providerName)
        {
        ...
        public Query<player> players { get; set; }
        public Query<character> characters { get; set; }
        public Query<feat> feats { get; set; }
        public Query<playercharacter> playercharacters { get; set; }
        public Query<characterfeat> characterfeats { get; set; }
        public Query<lammy> lammies { get; set; }
        public Query<characterlammy> characterlammies { get; set; }
        public Query<logfile> logfiles { get; set; }
        public Query<forgotpassword> forgotpasswords { get; set; }
